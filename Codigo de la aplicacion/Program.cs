...
internal class Program
{
    static void Main(string[] args)
    {
        ...
        //Nuevos operadores agregados
        Operador op3 = new Operador(3, "Maria");
        Operador op4 = new Operador(4, "Alberto");
        ...
        Llamada4.ConectarLlamada(op4, "Incendio");

        Console.WriteLine("\nVerificación de instancia única: " + (ReferenceEquals(Llamada1, Llamada2) && ReferenceEquals(Llamada1, Llamada3) && ReferenceEquals(Llamada1, Llamada4)));
